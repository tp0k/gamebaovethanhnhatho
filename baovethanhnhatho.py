...
# 3 - Tải hình ảnh
player = pygame.image.load("image/rabbit1.png")
...
gameover = pygame.image.load("image/gameover1.png")
...
while running:
    ...
    # 5 - xóa khung hình trước khi vẽ lại
    screen.fill(0)
    # 6 - vẽ các yếu tố khung hình
    ...
    # 6.1 - Đặt vị trí và xoay người chơi
    ...
    # 7 - cập nhật khung hình
    pygame.display.flip()
    # 8 - loop through the events
    for event in pygame.event.get():
        # kiểm tra xem sự kiện có phải là nút X không
